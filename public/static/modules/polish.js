...
(function () {
  ...
  const PAGES = [
    ...
    ['kpi_dashboard', '📊', 'KPI 대시보드', '분석/KPI'],
    ['weekly_insights', '💡', '주간 인사이트', '분석/KPI'],
    ['kpi_stats', '📈', 'KPI 통계', '분석/KPI'],
    ['kpi_benchmark', '🏆', '벤치마킹', '분석/KPI'],
    ['kpi_daily', '📝', '일간 기록', '분석/KPI'],
    ['kpi_targets', '🎯', '목표 설정', '분석/KPI'],
    ['reports', '📑', '월간 보고서', '분석/KPI'],
    ['marketing', '📈', '유입 분석', '마케팅'],
    ['heatmap', '🗺️', '유입 히트맵', '마케팅'],
    ['review_mgmt', '⭐', '리뷰 관리', '마케팅'],
    ['reviews', '🌟', '후기 관리', '마케팅'],
    ['surveys', '📋', '만족도 설문', '마케팅'],
    ['kakao', '💛', '카카오 알림톡', '마케팅'],
    ['hr_dashboard', '💼', 'HR 대시보드', 'HR'],
    ['hr_staff', '🧑‍⚕️', '직원 관리', 'HR'],
    ['gamification', '🏆', '성과 게이미피케이션', 'HR'],
    ['hire_postings', '📢', '채용 공고', 'HR'],
    ['hire_applicants', '🙋', '지원자 관리', 'HR'],
    ['hire_interviews', '🎤', '인터뷰', 'HR'],
    ...
    ['parking', '🅿️', '주차권 관리', '병원 운영'],
    ['parking_stats', '📊', '주차권 통계', '병원 운영'],
    ['free', '💬', '자유게시판', '커뮤니티'],
    ['praise', '💖', '칭찬하기', '커뮤니티'],
    ['mistake', '🛡️', '실수노트', '커뮤니티'],
    ['feedback_notes', '📚', '피드백 노트', '커뮤니티'],
    ['pf_index', '📊', '페이션트 인덱스', '시그니처'],
    ['knowledge', '📚', 'PF 지식베이스', '시그니처'],
