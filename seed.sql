...
-- 병원 설정 (위치 용어 커스텀)
UPDATE hospitals SET settings = '{"location_terms":{"chair":"체어","room":"진료실","floor":"층","surgery_room":"수술실","waiting_room":"대기실","consult_room":"상담실","xray_room":"촬영실","sterilization":"소독실"},"location_presets":[{"label":"2F 진료실A","floor":"2F","room":"진료실 A"},{"label":"2F 진료실B","floor":"2F","room":"진료실 B"},{"label":"3F 수술실1","floor":"3F","room":"수술실 1"},{"label":"3F 수술실2","floor":"3F","room":"수술실 2"},{"label":"4F 교정실","floor":"4F","room":"교정실"}],"operating_hours":{"weekday":{"start":"09:00","end":"19:00","enabled":true},"saturday":{"start":"09:00","end":"14:00","enabled":true},"sunday":{"start":"","end":"","enabled":false},"lunch":{"start":"13:00","end":"14:00","enabled":true},"evening":{"start":"","end":"","enabled":false,"label":"야간진료"},"regular_holidays":["sun","national"],"holiday_notice":"일요일·공휴일 휴진"},"floor_map":[{"name":"1F","description":"접수·대기·상담","spaces":[{"name":"접수 데스크","type":"office","chairs":0,"note":"접수 및 수납"},{"name":"대기실","type":"waiting","chairs":0,"note":"환자 대기 공간"},{"name":"상담실 1","type":"consult","chairs":0,"note":"초진 상담"},{"name":"상담실 2","type":"consult","chairs":0,"note":"교정 상담"}]},{"name":"2F","description":"일반 진료","spaces":[{"name":"진료실 A","type":"treatment","chairs":2,"note":"보존·보철"},{"name":"진료실 B","type":"treatment","chairs":1,"note":"보존·근관"},{"name":"촬영실","type":"xray","chairs":0,"note":"파노라마·CT"}]},{"name":"3F","description":"수술·임플란트","spaces":[{"name":"수술실 1","type":"surgery","chairs":1,"note":"임플란트"},{"name":"수술실 2","type":"surgery","chairs":1,"note":"임플란트·발치"},{"name":"수술실 3","type":"surgery","chairs":1,"note":"GBR·시너스"}]},{"name":"4F","description":"교정","spaces":[{"name":"교정실","type":"orthodontics","chairs":1,"note":"교정 전용"}]},{"name":"B1","description":"소독·창고","spaces":[{"name":"소독실","type":"sterilization","chairs":0,"note":"기구 소독·멸균"},{"name":"창고","type":"storage","chairs":0,"note":"재료·장비 보관"}]}]}' WHERE id = 'h-demo';
